...
2. [chat-voice-runtime.zh-CN.md](chat-voice-runtime.zh-CN.md)，理解聊天、ASR、VAD 和 TTS 的运行时主链路。
3. [stage-and-settings.zh-CN.md](stage-and-settings.zh-CN.md)，理解首页双态布局、设置入口和本地偏好。
4. 交叉核对相关后端模块文档：
