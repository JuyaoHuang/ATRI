...
created: 2026-04-25
updated: 2026-07-08
source: docs/configs/CN/CosyVoice3_TTS使用说明.md
related_code:
...
本文说明 ATRI 后端 `cosyvoice3_tts` Provider 的实现状态、配置方法、参数含义，以及 CosyVoice3 的音色模型机制。

用户侧最小配置入口见：[TTS 配置说明](../../../configs/CN/TTS配置说明.md)。
