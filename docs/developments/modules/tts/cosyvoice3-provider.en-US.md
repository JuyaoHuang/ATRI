...
created: 2026-04-25
updated: 2026-07-09
source: docs/configs/EN/CosyVoice3-TTS-usage.md
related_code:
...
This document describes the implementation status, configuration methods, parameter meanings, and voice model mechanisms of the `cosyvoice3_tts` Provider in the ATRI backend.

For the user-facing minimal configuration entry, see [TTS Configuration Guide](../../../configs/EN/TTS-configuration.md).
