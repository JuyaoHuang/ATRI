...
> 旧设计稿说明：
> 当前实现请优先阅读 [../../modules/frontend/README.zh-CN.md](../../modules/frontend/README.zh-CN.md)。
...
- **设计讨论**: `docs/developments/总结_前端对话历史.md` (Round 1-18)
- **完整对话**: `docs/developments/前端设计对话历史.md`
- **后端架构**: `docs/developments/module-design/CN/后端设计.md`
- **后端 API**: `docs/developments/module-design/CN/后端API接口文档.md`
...
- **ASR 模块**: `docs/developments/module-design/CN/ASR模块设计文档.md`
- **TTS 模块**: `docs/developments/module-design/CN/TTS模块设计文档.md`
- **Live2D 模块**: `docs/developments/module-design/CN/Live-2d设计文档.md`
